...
새벽 3시까지 릴스를 보고 계신가요? 이 앱은 당신이 좋아요를 누른 릴스와 시청 습관을 분석하여 당신의 숨겨진 디지털 성격을 알려줍니다.

## ✨ 주요 기능

*   **🧠 심리 분석 알고리즘**: 시청 시간, 콘텐츠 유형, 반응 방식을 기반으로 성격을 분석합니다.
*   **🎭 4가지 독특한 성격 유형**:
    *   **도파민 추적자 (The Dopamine Chaser)**: 짧고 강렬한 재미, 밈(Meme) 중독.
    *   **✨ 감성 큐레이터 (The Aesthetic Curator)**: 분위기, 무드보드, 시각적 스토리텔링 중시.
    *   **🧠 라이프 해커 (The Life Hacker)**: 자기계발, 정보 습득, 효율성 추구.
    *   **🦋 소셜 버터플라이 (The Social Butterfly)**: 공감, 소통, 공유를 즐김.
*   **🔒 철저한 프라이버시**: 모든 분석은 시뮬레이션이며 브라우저 내에서 로컬로 실행됩니다. 개인 데이터는 저장되거나 인스타그램으로 전송되지 않습니다.

## 🛠️ 기술 스택

*   **Frontend**: HTML5, CSS3 (Custom properties, Flexbox/Grid)
*   **Logic**: Vanilla JavaScript (ES6+ Modules)
*   **Tooling**: Vite (빠른 개발 서버 및 번들러)
